...
function Level4({ socket, isConnected, onBack, onComplete, isTransitioning }) {
  ...
  const getNamespaceColor = (nsId) => {
    ...
    return colors[ns?.color] || colors.cyan;
  };
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white relative overflow-hidden animate-fadeIn">
      <div className="fixed inset-0 z-0 opacity-30">
        ...
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-cyan-500 rounded-full blur-[150px]"></div>
      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl sm:text-3xl font-black text-cyan-500">LEVEL 4 </h1>
              </div>
            ...
            <div className="bg-black/60 backdrop-blur-xl border-2 border-cyan-500/30 rounded-3xl overflow-hidden">
              ...
              <div className="p-10 border-t border-cyan-500/30 bg-black/50">
                <button
                  ...
                  className="w-full px-8 py-4 bg-gradient-to-r from-cyan-600 to-cyan-600 hover:from-cyan-500 hover:to-cyan-500 text-white text-xl font-black rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105"
                >
                  Submit Quiz
                </button>
              </div>
        ...
        <div className="relative z-10">
            ...
            <div className="container mx-auto px-4 md:px-6 py-3 md:py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <h1 className="text-xl md:text-2xl lg:text-3xl font-black text-cyan-400">LEVEL 4</h1>
                </div>
          ...
          <div className="container mx-auto px-4 md:px-6 py-6 md:py-12 max-w-6xl">
            ...
            <div>
              ...
              <div className="bg-black/50 border border-blue-500/30 rounded-xl p-6 md:p-8 mb-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="bg-gradient-to-br from-blue-500/20 to-transparent border border-blue-500/30 rounded-xl p-4 text-center hover:border-blue-400 hover:scale-105 transition-all duration-300">
                    <div className="text-3xl mb-2">💬</div>
                    <div className="font-bold text-blue-400 mb-1">/chat</div>
                    <div className="text-xs text-gray-400">Chat users only</div>
                  </div>

                  <div className="bg-gradient-to-br from-blue-500/20 to-transparent border border-blue-500/30 rounded-xl p-4 text-center hover:border-blue-400 hover:scale-105 transition-all duration-300">
                    <div className="text-3xl mb-2">🎮</div>
                    <div className="font-bold text-blue-400 mb-1">/game</div>
            ...
            {/* Real-World Examples */}
            <div className="mt-12 md:mt-15 mb-8">
              <h3 className="text-2xl md:text-3xl font-black mb-6 text-cyan-400 flex items-center gap-2 md:gap-3">
              ...
              <div className="grid md:grid-cols-3 gap-4 md:gap-6">
                <div className="bg-gradient-to-br from-blue-500/20 to-transparent border-2 border-blue-500/30 rounded-xl md:rounded-2xl p-4 md:p-6 hover:border-blue-400 hover:scale-105 transition-all duration-300">
                  ...
                  <h4 className="text-lg md:text-xl font-black mb-2 text-blue-300">Slack</h4>
                  ...
                  <div className="bg-cyan-500/10 rounded-lg p-2 text-xs">
                    <code className="text-cyan-400">/workspace-abc</code>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-blue-500/20 to-transparent border-2 border-blue-500/30 rounded-xl md:rounded-2xl p-4 md:p-6 hover:border-blue-400 hover:scale-105 transition-all duration-300">
                  <div className="text-3xl md:text-4xl mb-3">🎮</div>
                  <h4 className="text-lg md:text-xl font-black mb-2 text-blue-300">Gaming Platform</h4>
                  <p className="text-xs md:text-sm text-gray-300 mb-3">
                    Lobby, games, spectate → Separate namespaces
                  </p>
                  <div className="bg-cyan-500/10 rounded-lg p-2 text-xs">
                    <code className="text-blue-400">/lobby, /game-1</code>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-blue-500/20 to-transparent border-2 border-blue-500/30 rounded-xl md:rounded-2xl p-4 md:p-6 hover:border-blue-400 hover:scale-105 transition-all duration-300">
                  <div className="text-3xl md:text-4xl mb-3">🏢</div>
                  <h4 className="text-lg md:text-xl font-black mb-2 text-blue-300">SaaS App</h4>
                  <p className="text-xs md:text-sm text-gray-300 mb-3">
                    Each customer gets their own namespace
                  </p>
                  <div className="bg-cyan-500/10 rounded-lg p-2 text-xs">
                    <code className="text-blue-400">/tenant-123</code>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8 md:mb-12 bg-black/60 border-2 border-cyan-500/30 rounded-2xl md:rounded-3xl overflow-hidden">
              ...
              <div className="p-4 md:p-8 grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-bold text-cyan-400 mb-3">Server:</h4>
                  <div className="bg-black rounded-xl border border-cyan-500/30 overflow-hidden">
                    ...
                    <pre className="p-4 text-xs md:text-sm overflow-x-auto">
                      <code className="text-cyan-400">{`// Chat namespace
...
game.on('connection', socket => {
  // Only gamers
                ...
                <div>
                  <h4 className="font-bold text-cyan-400 mb-3">Client:</h4>
                  <div className="bg-black rounded-xl border border-cyan-500/30 overflow-hidden">
                    <div className="px-4 py-2 bg-black/80 border-b border-cyan-500/30 flex gap-2">
                      <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-red-500"></div>
                      <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-yellow-500"></div>
...
const gameSocket = 
      ...
      <div className={`min-h-screen bg-[#0a0f1e] text-white relative overflow-hidden transition-opacity duration-300 ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center p-4 md:p-6">
          <div className="max-w-3xl w-full">
            ...
            <div className="bg-black/60 backdrop-blur-xl border-2 border-cyan-500/30 rounded-2xl md:rounded-3xl overflow-hidden">
              <div className="p-6 md:p-10 border-b border-cyan-500/30 bg-cyan-500/5 text-center">
                <div className="text-5xl md:text-7xl mb-4 md:mb-6">🚀</div>
                <h2 className="text-3xl md:text-5xl font-black mb-2 md:mb-3 text-cyan-400">Join a Namespace</h2>
                <p className="text-sm md:text-xl text-gray-300">Choose your namespace and start chatting</p>
              </div>

              <div className="p-6 md:p-10">
                <div className="mb-6">
                  <label className="block text-xs md:text-sm font-bold text-cyan-300 mb-3">YOUR NAME</label>
                  <input
                    type="text"
                    value={username}
                    ...
                    maxLength={20}
                    className="w-full px-4 md:px-6 py-3 md:py-4 bg-black/90 border-2 border-cyan-500/30 rounded-xl md:rounded-2xl focus:border-cyan-500 focus:outline-none text-white text-base md:text-xl placeholder-gray-600"
                  />
                </div>

                <div className="mb-6">
                  <label className="block text-xs md:text-sm font-bold text-cyan-300 mb-3">SELECT NAMESPACE</label>
                ...
                <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-4">
                  <div className="flex gap-3">
                    ...
                    <div className="text-xs md:text-sm text-gray-300">
                      <strong className="text-cyan-300">Tip:</strong> Open in multiple tabs, join different namespaces, and see how they're completely isolated!
                    </div>
                  </div>
                </div>
              </div>
  ...
  const colors = currentNs ? getNamespaceColor(selectedNamespace) : { text: 'text-cyan-400', border: 'border-cyan-500/30' };
                    ...
                    {msg.type === 'system' ? (
                      ...
                      <div className={`${msg.sender === 'You' ? 'text-right' : ''}`}>
                        <div className={`inline-block max-w-[85%] p-3 md:p-4 rounded-xl md:rounded-2xl ${
                          msg.sender === 'You'
                            ? `bg-gradient-to-r from-cyan-600 to-cyan-600 text-white shadow-lg ${colors.shadow}`
        ...
        <div className="border-t border-cyan-500/30 bg-black/60 backdrop-blur-xl p-4">
          <div className="container mx-auto max-w-4xl flex gap-3">
            ...
            <button
              ...
              className="px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-cyan-600 to-cyan-600 hover:from-cyan-500 hover:to-cyan-500 text-white font-bold rounded-xl md:rounded-2xl disabled:opacity-50 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/50 text-sm md:text-base"
            >
              Send
            </button>
          </div>
        ...
        <div className="border-t border-cyan-500/30 bg-black/60 backdrop-blur-xl p-4">
          <div className="container mx-auto max-w-4xl text-center">
            <button
              ...
              className="px-12 py-6 bg-gradient-to-r from-cyan-600 via-cyan-600 to-cyan-600 hover:from-cyan-500 hover:via-cyan-500 hover:to-cyan-500 text-white text-2xl font-black rounded-3xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/50 flex items-center gap-4 mx-auto"
            >
              <span>🧠</span>
