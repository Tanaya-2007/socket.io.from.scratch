      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4 md:p-6">
        <div className="max-w-6xl w-full">
          ...
          <button
              ...
              className="group relative bg-black/60 backdrop-aqua-xl border-2 border-blue-500/30 rounded-2xl md:rounded-3xl p-6 md:p-10 hover:border-blue-400 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-500 text-left overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative z-10">
                <div className="text-5xl md:text-6xl mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">🎮</div>
                <div className="mb-4 md:mb-6">
                  <div className="text-xs md:text-sm font-bold text-blue-400 mb-1 md:mb-2">LEVEL 9</div>
          ...
          <button
              ...
              className="group relative bg-black/60 backdrop-aqua-xl border-2 border-purple-500/30 rounded-2xl md:rounded-3xl p-6 md:p-10 hover:border-purple-400 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/30 transition-all duration-500 text-left overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative z-10">
                <div className="text-5xl md:text-6xl mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">💾</div>
                <div className="mb-4 md:mb-6">
                  <div className="text-xs md:text-sm font-bold text-purple-400 mb-1 md:mb-2">LEVEL 10</div>
                  <h3 className="text-2xl md:text-4xl font-black mb-2 md:mb-3 text-white">DATABASE INTEGRATION</h3>
                  <p className="text-sm md:text-lg text-gray-400">Persist messages, load chat history, and track message receipts - just like WhatsApp!</p>
                </div>
                <div className="flex items-center gap-2 md:gap-3 text-purple-400 font-bold text-sm md:text-base">
                  <span>Start Learning</span>
                  <span className="group-hover:translate-x-2 transition-transform">→</span>
          ...
          {/* Level 11 */}
           <button
              ...
              className="group relative bg-black/60 backdrop-cyan-xl border-2 border-cyan-500/30 rounded-2xl md:rounded-3xl p-6 md:p-10 hover:border-cyan-400 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/30 transition-all duration-500 text-left overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative z-10">
                <div className="text-5xl md:text-6xl mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">🛡️</div>
                <div className="mb-4 md:mb-6">
                  <div className="text-xs md:text-sm font-bold text-cyan-400 mb-1 md:mb-2">LEVEL 11</div>
                  <h3 className="text-2xl md:text-4xl font-black mb-2 md:mb-3 text-white">Rate Limiting & Security</h3>
                  <p className="text-sm md:text-lg text-gray-400">Prevent spam, abuse, and DDoS attacks - think like a professional developer!</p>
                </div>
                <div className="flex items-center gap-2 md:gap-3 text-cyan-400 font-bold text-sm md:text-base">
                  <span>Start Learning</span>
                  <span className="group-hover:translate-x-2 transition-transform">→</span>
           ...
           <button
            ...
            >
              ...
              <div className="relative z-10">
                <div className="text-5xl md:text-6xl mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">🌐</div>
                <div className="mb-4 md:mb-6">
                  <div className="text-xs md:text-sm font-bold text-cyan-400 mb-1 md:mb-2">LEVEL 12</div>
                  <h3 className="text-2xl md:text-4xl font-black mb-2 md:mb-3 text-white">Redis Adapter & Scaling</h3>
                  <p className="text-sm md:text-lg text-gray-400">Scale across multiple servers</p>
                </div>
                <div className="flex items-center gap-2 md:gap-3 text-cyan-400 font-bold text-sm md:text-base">
                  <span>Start Learning</span>
                  <span className="group-hover:translate-x-2 transition-transform">→</span>
