...
function Level11({ socket, isConnected, onBack, isTransitioning }) {
            ...
            <div className="container mx-auto px-4 md:px-6 py-3 md:py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <h1 className="text-xl md:text-2xl lg:text-3xl font-black text-cyan-500">LEVEL 11 QUIZ</h1>
                </div>
                ...
                <div className="bg-black/90 backdrop-blur-xl rounded-2xl md:rounded-3xl border border-cyan-500/30 overflow-hidden">
                  ...
                  <div className="p-4 md:p-10 border-t border-cyan-500/30 bg-black/50">
                    <button
                      ...
                      className="w-full px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-cyan-600 to-cyan-600 hover:from-cyan-500 hover:to-cyan-500 text-white font-bold rounded-xl md:rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105 text-sm md:text-lg"
                    >
                      Submit Quiz
                    </button>
                  </div>
                  ...
                  <div className="p-6 md:p-10 text-center">
                    ...
                    <p className="text-base md:text-xl text-gray-300 mb-6 md:mb-8">
                      {(() => {
                        ...
                        if (percentage >= 80) return 'Excellent! Well secucyan! 🎉';
                    ...
                    <button
                      onClick={onBack}
                      className="px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-cyan-600 to-cyan-600 hover:from-cyan-500 hover:to-cyan-500 text-white font-bold rounded-xl md:rounded-2xl transition-all duration-300 transform hover:scale-105 text-sm md:text-lg"
                    >
                      Back to Levels
                    </button>
                  </div>
          ...
          <header className="bg-black/90 backdrop-blur-xl border-b border-cyan-500/30 sticky top-0 z-40">
            <div className="container mx-auto px-4 md:px-6 py-3 md:py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  <div className="text-2xl md:text-3xl">⚡</div>
                  <h1 className="text-xl md:text-2xl lg:text-3xl font-black text-cyan-500">Level 11</h1>
                </div>
            ...
            <div className="mb-12 md:mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-4 md:gap-6">
                <div className="bg-gradient-to-br from-cyan-500/20 to-transparent border-2 border-cyan-500/30 rounded-xl md:rounded-2xl p-4 md:p-6 hover:border-cyan-400 hover:scale-105 transition-all duration-300">
                  ...
                  <h4 className="text-lg md:text-xl font-black mb-2 text-cyan-300">Twitter API</h4>
                  ...
                  <div className="bg-cyan-500/10 rounded-lg p-2 text-xs">
                    <code className="text-cyan-400">Prevents bot spam</code>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-cyan-500/20 to-transparent border-2 border-cyan-500/30 rounded-xl md:rounded-2xl p-4 md:p-6 hover:border-cyan-400 hover:scale-105 transition-all duration-300">
                  <div className="text-3xl md:text-4xl mb-3">📱</div>
                  <h4 className="text-lg md:text-xl font-black mb-2 text-cyan-300">WhatsApp</h4>
                  <p className="text-xs md:text-sm text-gray-300 mb-3">
                    ~65 messages per minute limit
                  </p>
                  <div className="bg-cyan-500/10 rounded-lg p-2 text-xs">
                    <code className="text-cyan-400">Stops spammers</code>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-cyan-500/20 to-transparent border-2 border-cyan-500/30 rounded-xl md:rounded-2xl p-4 md:p-6 hover:border-cyan-400 hover:scale-105 transition-all duration-300">
                  <div className="text-3xl md:text-4xl mb-3">🎮</div>
                  <h4 className="text-lg md:text-xl font-black mb-2 text-cyan-300">Discord</h4>
                  <p className="text-xs md:text-sm text-gray-300 mb-3">
                    5 messages per 5 seconds in chat
                  </p>
                  <div className="bg-cyan-500/10 rounded-lg p-2 text-xs">
                    <code className="text-cyan-400">Prevents flooding</code>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-5">
                  ...
                  <h4 className="text-xl font-black mb-2 text-cyan-300">Without Rate Limiting:</h4>
                ...
                <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-5">
                  ...
                  <ul className="space-y-2 text-gray-300 text-sm">
                    <li>• Controlled traffic - pcyanictable load</li>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <div className="bg-black rounded-lg border border-cyan-500/30 p-3">
                      <code className="text-cyan-400 text-sm">Simple but has "burst" problem at window edges</code>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-4 md:p-8">
                <div className="bg-black rounded-xl border border-cyan-500/30 overflow-hidden">
                  ...
                  <pre className="p-4 md:p-6 text-xs md:text-sm overflow-x-auto font-mono">
                    <code className="text-cyan-400">{`// SERVER - Simple Rate Limiter (Sliding Window)
      ...
      remaining: MAX_REQUESTS - validRequests.length
            ...
            <div className="mb-12 md:mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                <div className="bg-gradient-to-br from-cyan-500/10 to-transparent border border-cyan-500/30 rounded-xl md:rounded-2xl p-5 md:p-6 hover:scale-105 transition-transform duration-300">
                  <div className="text-2xl md:text-3xl mb-2 md:mb-3">✅</div>
                  <h4 className="text-lg md:text-xl font-black mb-2 text-cyan-300">Input Validation</h4>
                  <p className="text-sm md:text-base text-gray-300">Always validate & sanitize client data</p>
                </div>

                <div className="bg-gradient-to-br from-cyan-500/10 to-transparent border border-cyan-500/30 rounded-xl md:rounded-2xl p-5 md:p-6 hover:scale-105 transition-transform duration-300">
                  <div className="text-2xl md:text-3xl mb-2 md:mb-3">🔑</div>
                  <h4 className="text-lg md:text-xl font-black mb-2 text-cyan-300">Authentication</h4>
                  <p className="text-sm md:text-base text-gray-300">Use JWT tokens or session auth</p>
                </div>

                <div className="bg-gradient-to-br from-cyan-500/10 to-transparent border border-cyan-500/30 rounded-xl md:rounded-2xl p-5 md:p-6 hover:scale-105 transition-transform duration-300">
                  <div className="text-2xl md:text-3xl mb-2 md:mb-3">🔒</div>
                  <h4 className="text-lg md:text-xl font-black mb-2 text-cyan-300">Use HTTPS/WSS</h4>
                  <p className="text-sm md:text-base text-gray-300">Encrypt all Socket.IO traffic</p>
                </div>

                <div className="bg-gradient-to-br from-cyan-500/10 to-transparent border border-cyan-500/30 rounded-xl md:rounded-2xl p-5 md:p-6 hover:scale-105 transition-transform duration-300">
                  <div className="text-2xl md:text-3xl mb-2 md:mb-3">🚫</div>
                  <h4 className="text-lg md:text-xl font-black mb-2 text-cyan-300">CORS Configuration</h4>
        ...
        <header className="bg-black/90 backdrop-blur-xl border-b border-cyan-500/30">
          <div className="container mx-auto px-4 md:px-6 py-3 md:py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 md:gap-3">
                <div className="text-2xl md:text-3xl">⚡</div>
                <h1 className="text-lg md:text-2xl font-black text-cyan-400">LEVEL 11 QUIZ</h1>
              </div>
              
              <div className={`px-3 md:px-4 py-1.5 md:py-2 rounded-lg text-xs md:text-sm font-bold border-2 ${
                isBlocked ? 'bg-cyan-500/20 border-cyan-500 text-cyan-400' : 'bg-green-500/20 border-green-500 text-green-400'
              }`}>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
              ...
              <div className="bg-black/60 border border-cyan-500/30 rounded-xl p-4">
                <div className="text-2xl md:text-3xl font-black text-cyan-400">{sendCount}</div>
            ...
            <div className="bg-black/60 border-2 border-cyan-500/30 rounded-xl p-4 md:p-6 mb-6">
              ...
              <div className="flex gap-3 mb-4">
                <input
                  ...
                  disabled={isBlocked}
                  className="flex-1 px-4 py-3 bg-black/90 border-2 border-cyan-500/30 rounded-xl focus:border-cyan-500 focus:outline-none text-white disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <button
                  onClick={handleSendMessage}
                  disabled={!message.trim() || isBlocked}
                  className="px-6 py-3 bg-gradient-to-r from-cyan-600 to-cyan-600 hover:from-cyan-500 hover:to-cyan-500 text-white font-bold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                  Send
                </button>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="text-sm text-gray-300">
                  ...
                  <ul className="mt-2 space-y-1">
                    ...
                    <li>• Exceed limit → <strong className="text-cyan-400">10 second block</strong></li>
