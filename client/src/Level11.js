...
function Level11({ socket, isConnected, onBack, isTransitioning }) {
  ...
  const handleSendMessage = () => {
    ...
    addLog(`📤 Sending: "${message.trim()}"`, 'info');
    setMessage('');
  };
              ...
              {!quizSubmitted ? (
                ...
                <div className="bg-black/90 backdrop-blur-xl rounded-2xl md:rounded-3xl border border-red-500/30 overflow-hidden">
                  <div className="p-6 md:p-10 text-center">
                    ...
                    <button
                      onClick={onBack}
                      className="px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 text-white font-bold rounded-xl md:rounded-2xl transition-all duration-300 transform hover:scale-105 text-sm md:text-lg"
                    >
                      Back to Levels
                    </button>
                  </div>
      ...
      <div className="relative z-10 h-screen flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6">
          <div className="container mx-auto max-w-4xl">
            ...
            {isBlocked && blockedUntil && (
              <div className="bg-red-500/20 border-2 border-red-500 rounded-xl p-4 mb-6 animate-pulse">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-black text-red-400 text-lg">RATE LIMIT EXCEEDED!</h3>
            ...
            {/* Message Input */}
            <div className="bg-black/60 border-2 border-red-500/30 rounded-xl p-4 md:p-6 mb-6">
              <h3 className="text-xl font-black text-red-400 mb-4">Send a Message</h3>
